...
[glink color="orange" text="はじめから" x=120 y=420 target=*start]
[glink color="blue" text="つづきから" x=120 y=520 target=*load]
[glink color="gray" text="クレジット" x=120 y=620 width=100 size=18 target=*credit]
...
; [edit] 入力欄を出します。
[edit name="f.player_name" left="70" top="420" width="250" height="40" size="30" maxchars="8" initial="大和"]
